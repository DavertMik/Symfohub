...
abstract class BaseRepositoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'works'         => new sfWidgetFormChoice(array('choices' => array('yes' => 'yes', 'patch' => 'patch', 'no' => 'no', 'old' => 'old', 'unknown' => 'unknown'))),
    ...
    $this->setValidators(array(
      ...
      'works'         => new sfValidatorChoice(array('choices' => array(0 => 'yes', 1 => 'patch', 2 => 'no', 3 => 'old', 4 => 'unknown'), 'required' => false)),
